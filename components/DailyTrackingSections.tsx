...
import { ChecklistIcon, NarrativeIcon, TimeIcon, HealthIcon, AnalyticsIcon } from './icons';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-3xl font-bold text-neutral-800 dark:text-neutral-100">Daily Tracking</h2>
