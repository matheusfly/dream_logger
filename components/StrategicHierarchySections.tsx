...
import { FilterIcon, SortIcon, PlusIcon, ObjectivesIcon, TimelineIcon, KanbanIcon, ReportsIcon } from './icons';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <button className="mt-2 sm:mt-0 flex items-center px-4 py-2 text-sm font-medium text-white bg-primary hover:bg-primary-dark rounded-lg transition-colors shadow">
